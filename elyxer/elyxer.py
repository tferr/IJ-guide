...
class BibStylesConfig(object):
  ...
  abbrvnat = {
      ...
      u'@article':u'$authors. $title. <i>$journal</i>,{ {$volume:}$pages,} $month $year.{ doi: <a href="http://dx.doi.org/$doi">$doi</a>.}', 
  ...
  default = {
      ...
      u'@article':u'$authors: “$title”, <i>$journal</i>,{ pp. $pages,} $year.{ doi: <a href="http://dx.doi.org/$doi">$doi</a>.}', 
  ...
  plain = {
      ...
      u'@article':u'$authors. $title.{ <i>$journal</i>{, {$volume}{($number)}}{:$pages}{, $year}.}{ doi: <a href="http://dx.doi.org/$doi">$doi</a>.}{ $note.}', 
      ...
      u'cite':u'$index', 
      u'default':u'{$authors. }$title.{{ $publisher,} $year.}{ doi: <a href="http://dx.doi.org/$doi">$doi</a>.}{ $note.}', 
      }
