...
control key for shortcuts }in \textsf{\userinterface{\textsf{Edit\lyxarrow{}Options\lyxarrow{}\nameref{sub:Misc...}}}}
is checked.
...
\item [{\textsf{Analyze\lyxarrow{}\nameref{sub:Gels}Select\ First\ Lane}}] Assume
...
instead of run
\item [{\nameref{sub:Rectangular-Selection-Tool}\ and\ \nameref{sub:Oval-Selection-Tool}}] Forces
1:1 aspect ratio 
\item [{\nameref{sec:Area-selection-tools}}] Add selection to previous
one
\item [{\nameref{sub:Polygon-Selection-Tool}}] Shift-clicking on a node
duplicates it
\item [{\nameref{sub:Straight-Line-Selection}}] Forces line to be horizontal
or vertical
\item [{\nameref{sub:Segmented-Line-Selection}}] Shift-clicking on a node
duplicates it
\item [{\nameref{sec:Point-Tool}}] Shift-clicking adds points (\nameref{sec:Multi-point-Tool}
behavior)
\item [{\nameref{sec:Magnifying-Glass}}] Shift-clicking and dragging runs
\textsf{\userinterface{Image\lyxarrow{}Zoom\lyxarrow{}\nameref{sub:ZoomToSelection}}}
\end{description}
...
\begin{description}
\item [{\nameref{sub:Rectangular-Selection-Tool}\ and\ \nameref{sub:Oval-Selection-Tool}}] Selection
is resized around its center 
\item [{\nameref{sub:Straight-Line-Selection}}] Line is rotated/resized
around its center
\end{description}
