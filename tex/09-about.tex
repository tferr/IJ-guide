...
\footnote{DeFelipe \& Jones. Santiago Ramón y Cajal and methods in neurohistology.
...
\midrule
\addlinespace
September/October 2012 & Reviewed by Michael Schmid\tabularnewline\addlinespace
\addlinespace
July 2012 & Updated for v\,1.46r\\
Reviewed by Barry DeZonia\tabularnewline\addlinespace
\addlinespace
...
April 2010 & First edition: v\,1.43\tabularnewline\addlinespace
\bottomrule
\end{tabular}
\par\end{center}
...
We are extremely grateful to Alex Fernández for his wonderful \href{http://elyxer.nongnu.org/}{eLyXer},
Alex Gorbatchev for \href{http://alexgorbatchev.com/SyntaxHighlighter/}{SyntaxHighlighter},
Johannes Schindelin for assistance with the \href{http://fiji.sc/guide.git}{Git repository},
