...
\begin{tikzpicture}[overlay, transform shape, rotate=-45]
    \node[scale=2,above,at={(13.38,9.5)}, yslant=0, fill=blue!40, draw=blue!80, very thick,minimum size=1.8cm] {
        \Huge\textcolor{lessblack}{\textbf{\qquad IJ\,\theguideversion \qquad{}}}
    };%
    \node[scale=3,above,at={(13.42,8.95)}, yslant=0, minimum size=0.8cm] {
